...
export default class FooterIos extends Component {
  render() {
    return (
      <div style={{ paddingBottom: "26px" }} className="footer">
        <div
          onClick={() => {
            this.props.onNearbyTabClick();
          }}
          className={`footer-button ${this.props.selectedIndex == 0 &&
            "selected"}`}
        >
          <svg
        ...
        <div
          onClick={() => {
            this.props.onPopularTabClick();
          }}
          className={`footer-button ${this.props.selectedIndex == 1 &&
            "selected"}`}
        >
          <svg
            className="footer-button-icon "
